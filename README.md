...
* On the left panel are two mods entitled **lStewieAI's Tweaks - Reduced XP** and **lStewieAI's Tweaks - Normal XP** - this is a file loaded with options that change how the game plays. The most important setting in this file is experience rate. The reduced XP mod will cut experience gain in half, while the normal XP mod will restore XP gain to vanilla levels. In order to not break New California's beginning, **the Normal XP mod _must_ remain enabled until you have completed New California prologue by sleeping in your dormitory bed.** Once this has completed you may select either mod according to your preference. If you are choosing to skip New California you can enable the reduced XP mod from the beginning. 
